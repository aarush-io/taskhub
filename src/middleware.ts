...
export default auth((req) => {
  ...
  // Admins are redirected out of the worker dashboard to keep the two
  // experiences distinct (an admin who wants to test the worker view
  // can still do so via impersonation tooling added later).
